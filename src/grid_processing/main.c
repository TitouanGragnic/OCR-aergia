...
int main(int argc, char *argv[])
{
    ...
    struct img_file out[NUM_THREADS];
    ...
    out[th].img = copy_surface(edge_surface);
    out[th].file = "output/treatment/grayscale.png";
    ...
    out[th].img = copy_surface(edge_surface);
    out[th].file = "output/treatment/contrast.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    ...
    out[th].img = copy_surface(edge_surface);
    out[th].file = "output/treatment/brightness.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    ...
    out[th].img = copy_surface(edge_surface);
    out[th].file = "output/treatment/noise.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    ...
    out[th].img = copy_surface(edge_surface);
    out[th].file = "output/treatment/blur.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    ...
    out[th].img = copy_surface(edge_surface);
    out[th].file = "output/treatment/threshold.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    ...
    out[th].img = copy_surface(edge_surface);
    out[th].file = "output/treatment/sobel.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    ...
    out[th].img = copy_surface(edge_surface);
    out[th].file = "output/treatment/rotate.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    ...
    out[th].img = copy_surface(bin_surface);
    out[th].file = "output/treatment/scale.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    ...
    out[th].img = copy_surface(bin_surface);
    out[th].file = "output/treatment/perspective.png";
    pthread_create(&threads[th], NULL, saveThead, &out[th]);
    th++;
    if(dev_mod)
    {
